export class Menu {
    ...
    private highScoreText!: HTMLParagraphElement;
    ...
    private initDOM(): void {
        ...
        this.menuElement.id = 'game-over';
        this.menuElement.className = 'game-over';
        ...
        this.scoreText.className = 'score-display';
        ...
        this.highScoreText.id = 'high-score';
        this.highScoreText.className = 'high-score';
        this.highScoreText.style.cssText = `
            margin: 0;
            font-size: 18px;
            color: #ccc;
        `;
        ...
        this.menuElement.appendChild(this.scoreText);
        this.menuElement.appendChild(this.highScoreText);
    ...
    show(score: number, highScore: number): void {
        ...
        this.highScoreText.innerText = `Best: ${highScore}`;
